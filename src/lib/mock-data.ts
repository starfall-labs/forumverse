...
export const initialMockUsers: User[] = [
  { id: 'user1', email: 'alice@example.com', username: 'alice', displayName: 'Alice Wonderland', avatarUrl: 'https://placehold.co/40x40.png?text=A', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 30).toISOString(), followingIds: ['user2'], followerIds: ['user3'] },
  { id: 'user2', email: 'bob@example.com', username: 'bob', displayName: 'Bob The Builder', avatarUrl: 'https://placehold.co/40x40.png?text=B', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 60).toISOString(), followingIds: [], followerIds: ['user1'] },
  { id: 'user3', email: 'charlie@example.com', username: 'charlie', displayName: 'Charlie Brown', avatarUrl: 'https://placehold.co/40x40.png?text=C', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 5).toISOString(), followingIds: ['user1'], followerIds: [] },
  { id: 'user4', email: 'diana@example.com', username: 'diana', displayName: 'Diana Prince', avatarUrl: 'https://placehold.co/40x40.png?text=D', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 10).toISOString(), followingIds: [], followerIds: [] },
  { id: 'user5', email: 'edward@example.com', username: 'edward', displayName: 'Edward Nygma', avatarUrl: 'https://placehold.co/40x40.png?text=E', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 2).toISOString(), followingIds: [], followerIds: [] },
  { id: 'adminuser', email: 'admin@example.com', username: 'admin', displayName: 'Admin User', avatarUrl: 'https://placehold.co/40x40.png?text=ADM', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 100).toISOString(), followingIds: [], followerIds: [] },
];
